...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    ...
    toast('Your Register is Sucessfully');
    navigate('/')
    reset();
  };
  ...
  return (
    <section className="flex h-2/3 justify-center items-center my-10">
      <div className="card card-compact w-96 h-auto shadow-xl">
        <div className="card-body w-full">
          ...
          <div className="card-actions justify-center">
            ...
            <p className="text-xl text-primary text-center">
              <small>
                <Link to="/login"  className="text-primary font-bold">Already Have a Account? please Login</Link>
              </small>
            </p>
